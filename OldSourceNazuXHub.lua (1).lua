...
ImageLabel.Image = "rbxassetid://5009915795" -- Asset ID bạn yêu cầu
...
local Window = Fluent:CreateWindow({
    Title = "Banamà Cat Hub by phuocthinh281989",
    SubTitle = "by phuocthinh281989 ",
    TabWidth = 160,
...
Tabs.Info:CreateButton{
    Title = "Get Link thinh",
    Description = "",
    Callback = function()
        Window:Dialog{
            Title = "phuocthinh281989",
            Content = "",
            Buttons = {
                {
                    Title = "tiktok",
                    Callback = function()
                        setclipboard("@phuocthinh281989")
                    end
                },
                {
                    Title = "Cancel",
